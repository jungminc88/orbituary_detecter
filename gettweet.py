...
KEYS = { # 自分のアカウントで入手したキーを下記に記載
        'consumer_key':'oQHsivNU4OZqGY1JpvqlxYhBr',
        'consumer_secret':'EpoHmD66pbj819o9sQ5f8s06Q5HnT4MNpdj9kLkWGzziIXQBD1',
        'access_token':'438898022-rJmf4GwU57A8xCVjeYpsTQZyKMXEZkkDIKlYeOdE',
        'access_secret':'bkCQOE35kBvodwsmBIAiJynuppz33Tb1YckyIIxPZUg7p',
       }
